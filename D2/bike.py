...
axle_contrux_line = D2line(D2(400,90),D2(700,90))
p.add_line(axle_contrux_line,stroke="#0f0",stroke_width=2)

ppoint = fork_contrux_line.intersect(axle_contrux_line)
p.add_dot(ppoint,r=8,fill="#f00")
...
p.add_dot(apoint,r=8,fill="#0f0")

fpoint = ppoint.polar(-73,opp)
p.add_dot(fpoint,r=8,fill="#00f")

offset_contrux_line = D2line(fpoint,apoint)
p.add_line(offset_contrux_line,stroke="#ff0",stroke_width=2)
